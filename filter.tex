...
However, this choice is only meaningful when the step will be shown to the user: if action selection in the next step yields \(\ActSkip\), then the stepper picks one redex deterministically (in practice, the first) and continues.
