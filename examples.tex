...
factorial trace to its key steps. We now use a richer
example---mapping a function over a list---to introduce the full set
of filter primitives and show how they compose.
...
fully-evaluated arguments. We give the formal pattern-matching rules
in Section~\ref{sec:filter}. We provide four filter constructs:
\begin{itemize}
...
third and sixth lines show \code{<square>(1)} and \code{<square>(2)} being expanded into
